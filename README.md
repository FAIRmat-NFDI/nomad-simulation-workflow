...
```
pip install dist/nomad-simulation-workflow-0.1.0
```
...
### License
Distributed under the terms of the `Apache Software License 2.0`_ license, "nomad-simulation-workflow" is free and open source software
